            ...
            <div>
              ...
              <div className="space-y-3 text-sm">
                ...
                <p className="flex items-start gap-2 text-gray-400">
                  ...
                  <a href="mailto:info@monera.work" className="hover:text-brand-purple transition-colors break-all text-sm">
                    info@monera.work
                  </a>
                </p>
                <p className="flex items-start gap-2 text-gray-400">
                  ...
                  <a href="https://wa.me/6285161391439" target="_blank" rel="noopener noreferrer" className="hover:text-brand-purple transition-colors text-sm">
                    +62 851-6139-1439
                  </a>
                </p>
              </div>
