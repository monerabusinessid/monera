      ...
      <div className="min-h-screen bg-[#f6f6f9] pt-24 pb-12">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-500 mt-1">{applications.length} offers received</p>
          </div>
          ...
          {applications.length === 0 ? (
            <Card>
              <CardContent className="p-10 text-center">
                ...
                <p className="text-gray-600 mb-4">No offers yet</p>
            ...
            <div className="space-y-4">
              {applications.map((app) => (
                <Card key={app.id} className="hover:shadow-md transition-shadow border-green-200">
