...
export async function GET(request: NextRequest) {
  try {
    ...
    const { data, error } = await supabase
      .from('landing_talent_categories')
      .select('id, name, icon, count, display_order, is_active')
      .eq('is_active', true)
    ...
    console.error('Error in GET /api/landing/talent-categories:', error)
    return NextResponse.json({ success: false, error: error.message }, { status: 500 })
  }
}
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { name, icon, count, display_order } = body
    ...
    console.error('Error in POST /api/landing/talent-categories:', error)
    return NextResponse.json({ success: false, error: error.message }, { status: 500 })
  }
}
...
export async function PUT(request: NextRequest) {
  try {
    ...
    console.error('Error in PUT /api/landing/talent-categories:', error)
    return NextResponse.json({ success: false, error: error.message }, { status: 500 })
  }
}
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    console.error('Error in DELETE /api/landing/talent-categories:', error)
    return NextResponse.json({ success: false, error: error.message }, { status: 500 })
  }
}
